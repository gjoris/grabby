...
### Added
- Download cancellation: users can now stop active downloads with a Cancel button
- Download button shows "Downloading..." state during active downloads
...
[1.4.0]: https://github.com/gjoris/grabby/releases/tag/v1.4.0
[1.3.0]: https://github.com/gjoris/grabby/releases/tag/v1.3.0
